...
const ContactPage = () => {
  ...
  return (
    <div className="fade-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start" style={{ marginTop: 'var(--sp-md)' }}>
        ...
        {/* Right Column: Contact info & widgets */}
        <div className="lg:col-span-5 space-y-6">
          {/* Map placeholder */}
          <div style={{ height: 180, borderRadius: 'var(--r-2xl)', background: 'linear-gradient(135deg, #0a1628, #1a2a4a)', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', padding: 'var(--sp-md)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
            <div style={{ zIndex: 1 }}>
              <div style={{ fontSize: 14, fontWeight: 600 }}>Main Campus</div>
              <div style={{ fontSize: 12, opacity: .8 }}>450 Medical Plaza, NY 10012</div>
            </div>
            <button className="btn-outline" style={{ color: '#fff', borderColor: 'rgba(255,255,255,.3)', fontSize: 12, zIndex: 1 }}>Directions</button>
          </div>
          ...
          <div className="glass-card">
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--on-surface-variant)', marginBottom: 'var(--sp-sm)' }}>Patient Support Lead</div>
