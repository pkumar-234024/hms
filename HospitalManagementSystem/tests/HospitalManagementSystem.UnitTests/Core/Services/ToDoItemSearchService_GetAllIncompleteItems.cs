...
using HospitalManagementSystem.Core.ProjectAggregate;
using HospitalManagementSystem.Core.Services;
using HospitalManagementSystem.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace HospitalManagementSystem.UnitTests.Core.Services
{
