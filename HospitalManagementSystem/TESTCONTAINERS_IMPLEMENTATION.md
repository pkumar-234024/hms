...
**Updated `tests\HospitalManagementSystem.FunctionalTests\HospitalManagementSystem.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\HospitalManagementSystem.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\HospitalManagementSystem.FunctionalTests\HospitalManagementSystem.FunctionalTests.csproj
```
