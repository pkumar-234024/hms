...
1. Set `HospitalManagementSystem.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../HospitalManagementSystem.Infrastructure/HospitalManagementSystem.Infrastructure.csproj -s HospitalManagementSystem.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../HospitalManagementSystem.Infrastructure/HospitalManagementSystem.Infrastructure.csproj -s HospitalManagementSystem.Web.csproj
```
